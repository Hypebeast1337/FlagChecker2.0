...
const resources = {
  en: {
    translation: {
      ...
      // Reset Modal
      "resetCountriesTitle": "Reset countries selection",
      ...
      "countriesCountDesc": "we recognize countries based on the list of UN Member States for 2025 - 193 member countries and two non-member states Palestine and Vatican and in addition Kosovo, totaling 196. Source:",
  ...
  pl: {
    translation: {
      ...
      "countriesCountDesc": "definiujemy kraj według listy Państw Członkowskich ONZ na rok 2025 - 193 kraje członkowskie i dwa państwa niebędące członkami tj. Palestyna i Watykan oraz dodatkowo Kosowo, czyli łącznie 196. Źródło:",
